...
class _MovieSelectorState extends State<MovieSelector> {
  var movies_response = [
    ...
    },
    {
      ...
      'rating': 5.6,
      'short_description':
          'The film is based on the Chinese folklore "The Ballad of Mulan" and is a live-action adaptation of Disney\'s 1998 animated film of the same name',
      'full_description':
    ...
    },
    {
      ...
      'rating': null,
      'short_description':
          'A film based on the animated television series SpongeBob SquarePants.',
      'full_description':
    ...
    },
    {
      ...
      'short_description': '',
      'full_description':
          'It stars Song Kang-ho, Lee Sun-kyun, Cho Yeo-jeong, Choi Woo-shik, Park So-dam, Jang Hye-jin, and Lee Jung-eun and follows the members of a poor family who scheme to become employed by a wealthy family by infiltrating their household and posing as unrelated, highly qualified individuals.',
    ...
    },
    {
      ...
      'language': 'English',
      'distributed_by':
          'Entertainment One, Universal Pictures, Alibaba Pictures',
    },
  ];
  var selectdMovie;
